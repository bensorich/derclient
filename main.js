...
bot.on('message', message => {
    ...
    if (msg.startsWith(prefix + 'PURGE')) { // This time we have to use startsWith, since we will be adding a number to the end of the command.
        ...
        async function purge() {
            ...
            if (!message.member.roles.find("name", "Administrator & Developer")) { // This checks to see if they DONT have it, the "!" inverts the true/false
                message.channel.send('You need the \`Administrator & Developer\` role to use this command.'); // This tells the user in chat that they need the role.
